...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_latitude? Latitude
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_latitude?>("latitude"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_longitude? Longitude
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_longitude?>("longitude"); }
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "latitude", n => { Latitude = n.GetObjectValue<global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_latitude>(global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_latitude.CreateFromDiscriminatorValue); } },
                { "longitude", n => { Longitude = n.GetObjectValue<global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_longitude>(global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_longitude.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_latitude>("latitude", Latitude);
            writer.WriteObjectValue<global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_longitude>("longitude", Longitude);
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.20.0")]
        public partial class PrinterLocation_latitude : IBackedModel, IComposedTypeWrapper, IParsable
        {
            /// <summary>Stores model information.</summary>
            public IBackingStore BackingStore { get; private set; }
...
#nullable restore
...
#endif
            /// <summary>
            /// Instantiates a new <see cref="global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_latitude"/> and sets the default values.
            /// </summary>
            public PrinterLocation_latitude()
            {
                BackingStore = BackingStoreFactorySingleton.Instance.CreateBackingStore();
            }
            /// <summary>
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_latitude"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_latitude CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_latitude();
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.20.0")]
        public partial class PrinterLocation_longitude : IBackedModel, IComposedTypeWrapper, IParsable
        {
            /// <summary>Stores model information.</summary>
            public IBackingStore BackingStore { get; private set; }
            /// <summary>Composed type representation for type <see cref="double"/></summary>
...
#nullable restore
...
#endif
            /// <summary>
            /// Instantiates a new <see cref="global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_longitude"/> and sets the default values.
            /// </summary>
            public PrinterLocation_longitude()
            {
                BackingStore = BackingStoreFactorySingleton.Instance.CreateBackingStore();
            }
            /// <summary>
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_longitude"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_longitude CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::Microsoft.Graph.Models.PrinterLocation.PrinterLocation_longitude();
                if(parseNode.GetEnumValue<global::Microsoft.Graph.Models.ReferenceNumeric>() is global::Microsoft.Graph.Models.ReferenceNumeric referenceNumericValue)
                {
                    result.ReferenceNumeric = referenceNumericValue;
                }
